function [C,CM,DISTTOCM,NRCLRET] = kmeansprun_ext_merge5(A,MAXNRPOINT,EXTTRESH,QUALCRIT,RAND,PLOT,DIM,A_ORG)

% [C,CM,DISTTOCM,NRCLRET] = kmeansprun_ext_merge5(A,MAXNRPOINT,EXTTRESH,QUALCRIT,RAND,PLOT,DIM,A_ORG)
